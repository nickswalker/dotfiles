...
sudo apt install -y chrome-gnome-shell curl dconf-cli ecryptfs-utils git gtk-recordmydesktop lvm2 ssh sshfs tree tmux ubuntu-gnome-desktop zsh

sudo snap install gimp inkscape slack spotify sublime-text --classic
