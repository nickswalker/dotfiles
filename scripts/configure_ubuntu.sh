...
sudo apt install -y chrome-gnome-shell curl dconf-cli ecryptfs-utils git lvm2 ssh sshfs tree tmux ubuntu-gnome-desktop zsh

sudo snap install caprine gimp inkscape slack spotify --classic
